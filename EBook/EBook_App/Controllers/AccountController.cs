...
namespace EBook_App.Controllers
{
    public class AccountController : Controller
    {
        ...
        //        _PublicClaimObjectsNew.P_Get_User_Info = (ado == null ? null : ado.P_Get_User_Info(_PublicClaimObjectsNew.username, AppEnum.ApplicationId.AppID));
        ...
        {
            SignIn_Req req = new SignIn_Req();
            req.UserName = "HAMMAS.KHAN";
            req.Password = "Metro@123";
            req.RememberMe = true;
            var a = await account.LoginAsync(req, account.GenerateToken ,cancellationToken);
            return View();
        }
        #endregion Home
